...
class Pokemon(models.Model):
    ...
    title_en = models.CharField('Имя на английском', max_length=200, default=None, blank=True)
    title_jp = models.CharField('Имя на японском', max_length=200, default=None, blank=True)
